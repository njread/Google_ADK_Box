...
decision_router = LlmAgent(
    ...
    directed to the Box Search agent or Box Hub agent based on the content of the query.
    ...
    Examples:
    - Query: "Find information on banking regulations" -> Output: "box_hub"
    - Query: "What documents mention Q4 sales targets?" -> Output: "box_search"
    - Query: "Tell me about the new banking product launch materials" -> Output: "box_hub"
...
class BoxFlowAgent(BaseAgent):
    ...
    or Box Hub agent based on the content of the query.
    """
    ...
    async def _run_async_impl(
        ...
        # Strip whitespace and newlines from the decision
