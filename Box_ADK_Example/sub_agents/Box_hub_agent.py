...
Box_hub_agent = LlmAgent(
    ...
    4. You do not always need to respond, If there is another agent that has provided a response you can just wiat untill you are expicitly called by the user. 
    """,
